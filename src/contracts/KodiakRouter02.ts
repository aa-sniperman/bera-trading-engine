...
export interface KodiakRouter02Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface KodiakRouter02 extends BaseContract {
  connect(runner?: ContractRunner | null): KodiakRouter02;
  waitForDeployment(): Promise<this>;

  interface: KodiakRouter02Interface;
