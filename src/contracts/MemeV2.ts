...
export interface MemeV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASIS_POINTS"
      | "MAX_TOKENS"
  ...
  encodeFunctionData(
    functionFragment: "injectLiquidity",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, BigNumberish, boolean, AddressLike, AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace BondingCurveEndedEvent {
  export type InputTuple = [token: AddressLike, factory: AddressLike];
  export type OutputTuple = [token: string, factory: string];
...
export interface MemeV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MemeV2;
  waitForDeployment(): Promise<this>;

  interface: MemeV2Interface;
  ...
  injectLiquidity: TypedContractMethod<[], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "injectLiquidity"
  ...
  getEvent(
    key: "BondingCurveEnded"
  ): TypedContractEvent<
    BondingCurveEndedEvent.InputTuple,
    BondingCurveEndedEvent.OutputTuple,
    BondingCurveEndedEvent.OutputObject
  >;
  getEvent(
    key: "Buy"
  ): TypedContractEvent<
  ...
  filters: {
    "BondingCurveEnded(address,address)": TypedContractEvent<
      BondingCurveEndedEvent.InputTuple,
      BondingCurveEndedEvent.OutputTuple,
      BondingCurveEndedEvent.OutputObject
    >;
    BondingCurveEnded: TypedContractEvent<
      BondingCurveEndedEvent.InputTuple,
      BondingCurveEndedEvent.OutputTuple,
      BondingCurveEndedEvent.OutputObject
    >;

    "Buy(address,address,uint256,uint256,uint256,uint256,address)": TypedContractEvent<
      BuyEvent.InputTuple,
      BuyEvent.OutputTuple,
      BuyEvent.OutputObject
    >;
    ...
    "List(address,uint256,uint256,address,address)": TypedContractEvent<
      ListEvent.InputTuple,
      ListEvent.OutputTuple,
      ListEvent.OutputObject
    >;
    ...
    "ListingFeeCollected(address,address,address,address,uint256,uint256,uint256,address)": TypedContractEvent<
      ListingFeeCollectedEvent.InputTuple,
      ListingFeeCollectedEvent.OutputTuple,
      ListingFeeCollectedEvent.OutputObject
    >;
    ...
    "Sell(address,address,uint256,uint256,uint256,uint256,address)": TypedContractEvent<
      SellEvent.InputTuple,
      SellEvent.OutputTuple,
      SellEvent.OutputObject
    >;
    ...
    "TradingFeeCollected(address,address,address,address,uint256,uint256,uint256,uint256,uint256,bool,address)": TypedContractEvent<
      TradingFeeCollectedEvent.InputTuple,
      TradingFeeCollectedEvent.OutputTuple,
      TradingFeeCollectedEvent.OutputObject
    >;
    ...
    "WhitelistBuy(address,uint256,uint256,address)": TypedContractEvent<
      WhitelistBuyEvent.InputTuple,
      WhitelistBuyEvent.OutputTuple,
      WhitelistBuyEvent.OutputObject
    >;
