...
import type {
  HerculesV2Factory,
  HerculesV2FactoryInterface,
} from "../HerculesV2Factory";
...
export class HerculesV2Factory__factory {
  static readonly abi = _abi;
  static createInterface(): HerculesV2FactoryInterface {
    return new Interface(_abi) as HerculesV2FactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): HerculesV2Factory {
    return new Contract(address, _abi, runner) as unknown as HerculesV2Factory;
  }
}
