...
export class HerculesV2Pair__factory {
  static readonly abi = _abi;
  static createInterface(): HerculesV2PairInterface {
    return new Interface(_abi) as HerculesV2PairInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): HerculesV2Pair {
    return new Contract(address, _abi, runner) as unknown as HerculesV2Pair;
  }
}
