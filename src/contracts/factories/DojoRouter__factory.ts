...
import type { DojoRouter, DojoRouterInterface } from "../DojoRouter";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "DojoSwapV2InvalidPath",
    type: "error",
  },
  {
    inputs: [],
    name: "DojoSwapV2WrongAmountADeposited",
    type: "error",
  },
  {
    inputs: [],
    name: "DojoSwapV2WrongAmountBDeposited",
    type: "error",
  },
  {
    inputs: [],
    name: "DojoSwapV2WrongAmountDeposited",
    type: "error",
  },
  {
    inputs: [],
    name: "DojoSwapV2WrongAmounts",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct IDojoSwapV2Router.NftVaultLiquidityData",
        name: "vault",
        type: "tuple",
      },
    ],
...
export class DojoRouter__factory {
  static readonly abi = _abi;
  static createInterface(): DojoRouterInterface {
    return new Interface(_abi) as DojoRouterInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): DojoRouter {
    return new Contract(address, _abi, runner) as unknown as DojoRouter;
  }
}
