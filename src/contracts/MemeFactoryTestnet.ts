...
export interface MemeFactoryTestnetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createMeme"
...
export interface MemeFactoryTestnet extends BaseContract {
  connect(runner?: ContractRunner | null): MemeFactoryTestnet;
  waitForDeployment(): Promise<this>;

  interface: MemeFactoryTestnetInterface;
