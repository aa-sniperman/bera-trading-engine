...
export interface HoldsoRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH9"
      | "exactInput"
...
export interface HoldsoRouter extends BaseContract {
  connect(runner?: ContractRunner | null): HoldsoRouter;
  waitForDeployment(): Promise<this>;

  interface: HoldsoRouterInterface;
